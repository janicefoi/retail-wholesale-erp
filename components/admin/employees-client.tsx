...
export function EmployeesClient({ employees, currentUserId }: Props) {
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50 hover:bg-slate-50">
              ...
              <TableHead className="w-32 whitespace-nowrap">Date joined</TableHead>
                  ...
                  >
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-0.5">
                        {/* Edit — disabled for ADMIN and self */}
                        <Button
                          size="icon"
                          variant="ghost"
                          className="h-6 w-6 text-slate-400 hover:text-blue-600"
                          title="Edit employee"
                          disabled={isSelf || emp.role === "ADMIN"}
                        ...
                        <Button
                          ...
                          disabled={isSelf || emp.role === "ADMIN" || isToggling}
