...
export function ThermalReceipt({ sale }: ThermalReceiptProps) {
  ...
  const tax = Number(sale.taxAmount); // already extracted server-side (total × 16/116)
  ...
  return (
    ...
    >
      ...
      {/* ── Logo placeholder ──────────────────────────────────────────── */}
      {/* Replace with <Image src="/jsh-logo.png" ... /> when ready */}
      ...
      {/* VAT note — inclusive, shown below total */}
      ...
      {/* ── Footer ────────────────────────────────────────────────────── */}
      <div style={{ textAlign: "center", fontSize: "11px", margin: "4px 0 10px" }}>
